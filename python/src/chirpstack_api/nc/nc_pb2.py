...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\024io.chirpstack.api.ncB\026NetworkControllerProtoP\001Z)github.com/wereii/chirpstack-api/go/v3/nc'
